            ...
            <div>
              ...
              <div className="mt-9 flex flex-col gap-4 sm:flex-row sm:gap-5">
                <a
                  ...
                  className="btn-spotlight btn-spotlight-primary group inline-flex h-14 w-full items-center justify-center overflow-hidden rounded-[18px] pl-7 pr-3 text-[16px] font-semibold tracking-[-0.02em] text-white transition-all duration-300 hover:-translate-y-0.5 sm:w-auto"
                >
                ...
                <a
                  href="#solutions"
                  className="btn-spotlight btn-spotlight-secondary group relative inline-flex h-14 w-full items-center justify-center overflow-hidden rounded-[18px] pl-7 pr-3 text-[16px] font-semibold tracking-[-0.02em] text-[#06145b] transition-all duration-300 hover:-translate-y-0.5 sm:w-auto"
                >
                  <span className="relative z-10 whitespace-nowrap">
